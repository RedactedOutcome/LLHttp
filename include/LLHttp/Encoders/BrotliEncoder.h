...
namespace LLHttp{
    ...
    public:
        ...
        HttpEncodingErrorCode EncodeBrotli(HBuffer&& data, std::vector<HBuffer>& outputVector)noexcept{
            ...
            for(auto it = m_Input.begin(); it != m_Input.end(); it++){
                ...
                while(availableInput > 0){
                    ...
                    if(BrotliEncoderCompressStream(m_State, op, &availableInput, &inputData, &availableOut, &outputBuffer, nullptr) == BROTLI_FALSE){
